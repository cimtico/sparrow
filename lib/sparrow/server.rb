...
module Sparrow
  module Server
    ...
    spar_mattr_accessor :bytes_read
    spar_mattr_accessor :bytes_written
    spar_mattr_accessor :connections_made
    spar_mattr_accessor :connections_lost
    spar_mattr_accessor :get_count
    spar_mattr_accessor :set_count
